...
- [TemplaterDefaults plugin](https://github.com/josbeir/cakephp-templater-defaults) - Allow the use of default HTML attributes within CakePHP's string template system.
