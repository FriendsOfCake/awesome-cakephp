...
- [CakePHP-BsHelpers plugin](https://github.com/WebAndCow/CakePHP-BsHelpers) - Extension of the CakePHP's FormHelper and HtmlHelper to use the framework Bootstrap 3 more easily
