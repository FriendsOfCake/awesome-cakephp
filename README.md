...
- [MenuLink plugin](https://github.com/rrd108/cakephp-menulink) - A plugin to automatically add css class for the url which pointing to the current url eg. what is active.
