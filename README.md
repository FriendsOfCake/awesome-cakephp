...
- [CakeDC Users plugin](https://github.com/CakeDC/users/tree/3.1.x) - For allowing users to register and login, manage their profile and account validation. Social Login with Facebook and Twitter, RBAC, Remember me, SuperUser authorize, forgot password, admin management, etc.
