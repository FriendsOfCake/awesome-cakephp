...
- :strawberry: [Ali1/BruteForceProtectionComponent](https://github.com/Ali1/cakephp-brute-force-protection/) - Simple way to add Brute Force Protection to your installation without involving database.
