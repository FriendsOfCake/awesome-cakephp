...
- :strawberry: [MySQL Sakila Seed](https://github.com/cnizzardini/cakephp-sakila-plugin) - CakePHP migrations and data seeders for the MySQL Sakila Sample Database. Useful for creating quick demo applications.
