...
- [CakephpFixtureFactories plugin](https://github.com/vierge-noire/cakephp-fixture-factories) - Create your fixtures dynamically on a test basis, accelerate the writing and maintenance of your tests.
