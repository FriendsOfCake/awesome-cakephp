...
- [Crustum/Queue plugin](https://github.com/Crustum/cakephp-queue) - Dispatchable job helpers on top of cakephp/queue: self-dispatch, per-job queue config, tags, and pending/pushed events.
