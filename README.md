...
- [Simple Environment Manager](https://github.com/matscode/cakephp-simple-environment-manager) - Load right config file at the right Environment with ease and few setup.
